...
impl Store {
    // Identity-system CRUD (identity_*, agent_identity_*, bundle_identity_*)
    // moved to `super::identities` in Phase R.2 of the storage
    // modularization (SPEC_STORE_MODULARIZATION_2026_05_27.md). The
    // `impl Store {}` block there adds the same methods to this type.
