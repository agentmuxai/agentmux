...
## Related
- #1368 (the exit-130 code fix — correct), D#1205 (floating-pane/tear-off thread), `RETRO_BASHWRAP_EXIT130_2026_06_12.md (no longer in this repo)` (the original code-level retro — this one is the *delivery* retro).
