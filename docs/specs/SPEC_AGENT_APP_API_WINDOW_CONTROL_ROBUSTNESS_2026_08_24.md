...
**Date:** 2026-08-24
**Status:** draft — Phase 1 (Fixes 1-4, §2-5) implemented on branch `feat/agent-app-api-window-discovery`. Phase 2 (Fix 5, cross-instance naming, §6) and Fix 6 (§7, orphan discovery) remain draft/not started. §8's open item (Shell-tool exit-201 mystery) remains unresolved — not attempted here, per its own note.
