...
- Retro: [`docs/retro/2026-05-11-live-log-streaming-wrapper-failures.md`](../retros/2026-05-11-live-log-streaming-wrapper-failures.md) — full context of the β.A wedge and the pipe rewrite
