...
**Date:** 2026-06-16
**Status:** active — Phase 1 implemented (priority/background egress lanes + biased select); Phase 2 implemented (egress-side coalesce to latest-only per event×scope); Phases 3–4 proposed — #1782
**Author:** smike (agent)
