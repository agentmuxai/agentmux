...
| [`SPEC_AGENT_CLAUDE_IDENTITY_LOOKUP_2026_09_24`](SPEC_AGENT_CLAUDE_IDENTITY_LOOKUP_2026_09_24.md) | SPEC: an agent's own current Claude identity, in one read — no tool call, no guessing |
