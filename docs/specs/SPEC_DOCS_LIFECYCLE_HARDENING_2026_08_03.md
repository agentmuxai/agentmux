...
three, `docs/analysis/archive/` (6 files) and `docs/archive/` (27) are
straightforward to merge. `docs/specs/archive/` (61) is **not**, and the reason
