...
async fn route_command(
    ...
    match cmd {
        ...
        "show_save_layout_dialog" => commands::platform::show_save_layout_dialog(args).await,
        "show_open_layout_dialog" => commands::platform::show_open_layout_dialog(args).await,
