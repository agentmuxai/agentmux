...
// Splash window dimensions. Brain is 256×256 (rendered from
// `resources/brain.png` at build time); pad with BG color around it.
const SPLASH_SIZE: i32 = 280;
const BRAIN_W: i32 = 256;
const BRAIN_H: i32 = 256;
const BRAIN_X: i32 = (SPLASH_SIZE - BRAIN_W) / 2; // 12
const BRAIN_Y: i32 = (SPLASH_SIZE - BRAIN_H) / 2; // 12
...
unsafe fn composite(dib: &mut [u8], brain_alpha: u8) {
